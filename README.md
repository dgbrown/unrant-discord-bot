# Rant Reset Discord Bot

Written in JavaScript, based on the [discord bots getting started guide](https://discord.com/developers/docs/getting-started).
...
Ensure you are using the correct version of node (see .node-version)
